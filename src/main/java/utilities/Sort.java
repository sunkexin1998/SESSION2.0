...
public class Sort {
   ...
   public static void quickSortStringsWithBooleans(String[] sArray, boolean[] isStandardNegating, int l, int r) {
	      String sMiddle = sArray[(l + r) / 2];
	      int i = l;
	      int j = r;
	      ...
	      while(i <= j) {
	         ...
	         if (i < j) {
	            String sTemp = sArray[i];
	            boolean sTemp2 = isStandardNegating[i];
	            sArray[i] = sArray[j];
	            isStandardNegating[i] = isStandardNegating[j];
	            sArray[j] = sTemp;
	            isStandardNegating[j] = sTemp2;
	         }
	      ...
	      if (l < j) {
	    	  quickSortStringsWithBooleans(sArray, isStandardNegating, l, j);
	      }

	      if (i < r) {
	    	  quickSortStringsWithBooleans(sArray, isStandardNegating, i, r);
	      }
