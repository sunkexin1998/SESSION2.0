...
//        
        String argStr = "input /Users/sunkexin/eclipse-workspace/SESSION2.2_Maven/src/input/sof4423.txt trinary explainSentiPattern";
        classifier.initialiseAndRun(argStr.split(" "));
        
//        argStr = "input /Users/sunkexin/eclipse-workspace/SESSION2.2_Maven/src/input/sof4423_dev.txt trinary explainSentiPattern";
//        classifier.initialiseAndRun(argStr.split(" "));
//        
//        argStr = "input /Users/sunkexin/eclipse-workspace/SESSION2.2_Maven/src/input/sof4423_test.txt trinary explainSentiPattern";
//        classifier.initialiseAndRun(argStr.split(" "));
//        
//        argStr = "input /Users/sunkexin/eclipse-workspace/SESSION2.2_Maven/src/input/app.txt trinary explainSentiPattern";
//        classifier.initialiseAndRun(argStr.split(" "));
//        
//        argStr = "input /Users/sunkexin/eclipse-workspace/SESSION2.2_Maven/src/input/github585.txt trinary explainSentiPattern";
//        classifier.initialiseAndRun(argStr.split(" "));
//        
//        argStr = "input /Users/sunkexin/eclipse-workspace/SESSION2.2_Maven/src/input/jira388.txt trinary explainSentiPattern";
//        classifier.initialiseAndRun(argStr.split(" "));
//        
//        argStr = "input /Users/sunkexin/eclipse-workspace/SESSION2.2_Maven/src/input/jira926.txt trinary explainSentiPattern";
//        classifier.initialiseAndRun(argStr.split(" "));
//        
//        argStr = "input /Users/sunkexin/eclipse-workspace/SESSION2.2_Maven/src/input/sof1500.txt trinary explainSentiPattern";
//        classifier.initialiseAndRun(argStr.split(" "));
//        
//        argStr = "input /Users/sunkexin/eclipse-workspace/SESSION2.2_Maven/src/input/github1791.txt trinary explainSentiPattern";
//        classifier.initialiseAndRun(argStr.split(" "));
    ...
    public void initialiseAndRun(String[] args) {
        ...
        if (c.initialise()) {
            ...
            try {
                ...
                if (!f.exists()) {
                    System.out.println("Folder does not exist! 321" + c.resources.sgSentiStrengthFolder);
                }
            } catch (Exception var30) {
                System.out.println("Folder doesn't exist!324 " + c.resources.sgSentiStrengthFolder);
            }
    ...
    private void parseParametersForCorpusOptions(String[] args, boolean[] bArgumentRecognised) {
        for(int i = 0; i < args.length; ++i) {
            try {
                ...
                //是否解释表达模式
                if (args[i].equalsIgnoreCase("explainSentiPattern")) {
                	this.c.options.bgExplainSentiPattern = true;
                	bArgumentRecognised[i] = true;
                }
    ...
    private void printCommandLineOptions() {
        ...
        System.out.println(" dealWithdhsf (deal with the sentiment of ‘damn,hell,shit,fuck’ )");
        System.out.println(" dealWithConj (deal with conjunction)");
        System.out.println(" noDealWithPreprocess(don't preprocess)");
        System.out.println(" noDealWithRule_Trigger(shut down Rule_Trigger)");
        System.out.println(" noDealWithSubjunctiveMood (don't deal with subjunctive mood)");
        System.out.println(" noDealWithPolysemy (don't deal with polysemy)");
        System.out.println(" noDealWithNegative (don't deal with negative word)");
