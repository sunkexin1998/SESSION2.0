...
public class SentimentWords
{
    ...
    public boolean isSentimentWord(String sWord) {
    	int senti = getSentiment(sWord);
    	return senti!=0 && senti!=999;
    }
    ...
    public boolean initialise(String sFilename, ClassificationOptions options, int iExtraBlankArrayEntriesToInclude)
    {
        ...
        igSentimentWordsStrengthTake1 = new int[iLinesInFile + 10 + iExtraBlankArrayEntriesToInclude];
        sgSentimentWords = new String[iLinesInFile + 10 + iExtraBlankArrayEntriesToInclude];
        igSentimentWordsCount = 0;
        try
        {
